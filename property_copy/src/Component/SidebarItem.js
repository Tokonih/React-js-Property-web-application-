...
export default function SidebartItem() {
  ...
  return (
    <div>
      ...
      <div>
       <div className="prp"> <Link className="properties" to="/AdminDashboard">
          Dashboard
        </Link></div>
       ...
       <div className="prp"> <Link className="properties" to="/EditAgent">
        ...
        <div className="prp"><Link className="properties" to="/CreateProp">
          ...
          <div className="prp"><Link className="properties" to="/EditProperty">
          {" "}
          Edit Property        </Link></div>

        <div className="prp"><Link className="properties" to='/Properties'> Properties</Link></div>
        <div className="prp"><Link className="properties" to='/UnverifiedProp'> Unverified Properties</Link></div>
        <div className="prp"><Link className="properties"> Wishlist</Link></div>
        <div className="prp"><Link className="properties" to='/'> Merchant Login</Link></div>
      </div>
